    ...
    return (
        ...
        <Container maxWidth='xxl'>
            ...
            <Grid container className={classes.gridContainer} justifyContent="space-between" alignItems="stretch" spacing={3}>
                <Grid style={{marginTop:'20'}} item xs={12} sm={6} md={3}>
                    <AppBar elevation={7} position='static' color='inherit' className={classes.appBarSearch} >
                        ...
                        <ChipInput 
                            ...
                            variant="outlined"
                        />
                        <Button style={{    backgroundColor:"#3f51b5", color:'white'}} onClick={serachPost} variant='contained'>Search</Button>
                ...
                <Grid style={{marginTop:'20px'}} item xs={12} sm={6} md={9}> 
